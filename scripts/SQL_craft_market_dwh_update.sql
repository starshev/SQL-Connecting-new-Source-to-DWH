-- скрипт загрузки новых данных из всех источников в DWH

-- создание широкой таблицы tmp_sources с новыми данными из всех источников
...
-- обновление существующих записей и добавление новых в таблицу измерений dwh.d_craftsmans
...
-- обновление существующих записей и добавление новых в таблицу измерений dwh.d_products
...
-- обновление существующих записей и добавление новых в таблицу измерений dwh.d_customer
...
-- создание таблицы tmp_sources_fact с новыми данными в структуре фактовой таблицы dwh.f_order
...
-- обновление существующих записей и добавление новых в таблицу фактов dwh.f_order
